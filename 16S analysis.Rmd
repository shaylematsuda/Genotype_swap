...
```{r}
load("Data/Bac.seq_phyloseq2500.RData") #use RAW data that has been pruned. 
```
...
samp.df$genet.ID<-as.factor(samp.df$frag.id)

#adonis. 10/3 some missing home nursery, figure out!*******
