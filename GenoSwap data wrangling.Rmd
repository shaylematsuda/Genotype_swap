...
colnames(Genotype.Home)[2] ="Home.nursery"
    Genotype.Home$genet.ID[Genotype.Home$genet.ID == "T-DT-1"] <- "DT1" #change to correct name 	
    Genotype.Home$genet.ID[Genotype.Home$genet.ID == "T-DT-2"] <- "DT2" #change to correct name 	
    Genotype.Home$genet.ID[Genotype.Home$genet.ID == "Cheetos-b"] <- "Cheetos-B" #change to correct name 	
    Genotype.Home$genet.ID[Genotype.Home$genet.ID == "North Midchannel-A"] <- "North Midchannel" #change to correct name 	
    Genotype.Home$genet.ID[Genotype.Home$genet.ID == "Cheetos-b"] <- "Cheetos-B" #change to correct name 	
    Genotype.Home$genet.ID[Genotype.Home$genet.ID == "Cheetos-b"] <- "Cheetos-B" #change to correct name 
