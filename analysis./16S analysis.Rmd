...
```{r}
load("/Users/shaylematsuda/Desktop/Projects/GenoSwap/Genotype_swap/data/RData/Bac.seq_phyloseq2500.RData") #load cleaned data 
...
sample_sums(Bac.seq.c)
#view otu
# Extract abundance matrix from the phyloseq object
OTU1 = as(otu_table(Bac.seq.c), "matrix")
# transpose if necessary
if(taxa_are_rows(Bac.seq.c)){OTU1 <- t(OTU1)}
# Coerce to data.frame
OTUdf = as.data.frame(OTU1)#@write.csv(OTUdf,"OTUdf.csv")
...
write.csv(erich.tab.obs, "erich.tab.obs.csv")
    alpha$genet.ID <- as.factor(Bac.seq.c.sd$genet.ID)
    alpha$Home.nursery <- as.factor(Bac.seq.c.sd$Home.nursery)
    alpha$Away.nursery <- as.factor(Bac.seq.c.sd$Away.nursery)
    alpha$Swap <- as.factor(Bac.seq.c.sd$Swap)
